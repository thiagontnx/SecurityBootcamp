...
For that, you'll be required to configure a consistent protection policy, a DR site, and a backup system that is reliable enough against the ransonware *Krombopulos*.
